...
namespace GeoRelationsSample.Controllers
{
    public class LanguageInCountriesController : Controller
    {
        ...
        {
            var geoDbContext = _context.LanguageCountry.Include(l => l.CountryRef).Include(l => l.Languages);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var languageInCountry = await _context.LanguageCountry
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var languageInCountry = await _context.LanguageCountry.FindAsync(id);
            if (languageInCountry == null)
            {
                return NotFound();
            }
        ...
        {
            var languageInCountry = await _context.LanguageCountry.FindAsync(id);
            _context.LanguageCountry.Remove(languageInCountry);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.LanguageCountry.Any(e => e.Id == id);
        }
    }
}
